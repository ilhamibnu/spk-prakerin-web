                                ...
                                <div class="modal fade" id="Edit{{ $data->id }}">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="/data-nilai-kepentingan/{{ $data->id }}" method="post">
                                                @csrf
                                                @method('put')
    ...
    <div class="modal fade" id="Add">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="/data-nilai-kepentingan" method="post">
                    @csrf
                    @method('post')
                    <div class="modal-body">
                        @csrf
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label>Bobot</label>
                                <input type="nilai" name="bobot" class="form-control" placeholder="0.1">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
