...
@section('title', 'Data Cpe')

@section('title-bar', 'Data Cpe')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Data Cpe</h4>
                </div>
                                ...
                                <div class="modal fade" id="Edit{{ $data->id }}">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="/data-cpe/{{ $data->id }}" method="post">
                                                @csrf
                                                @method('put')
    ...
    <div class="modal fade" id="Add">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="/data-cpe" method="post">
                    @csrf
                    @method('post')
                    <div class="modal-body">
                        @csrf
